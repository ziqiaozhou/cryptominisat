...
public:
    ...
    void set_positional_description(const positional_options_description* desc)
    {
        m_positional_desc = desc;
    };
    const positional_options_description* get_positional_description() const
    {
        return m_positional_desc;
    };
    ...
    ///  return options
    const options_description& descriptions() const
    {
        return m_desc;
    }
    const positional_options_description* positional_descriptions() const
    {
        return m_positional_desc;
    }
};
