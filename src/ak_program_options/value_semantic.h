...
public:
    ...
    virtual bool is_bool_switch() const
    {
        return false;
    };
};
...
public:
    ...
    int* get_value() const
    {
        return (int*)(empty() ? &m_default : &m_value);
    };
    ...
    bool is_bool_switch() const
    {
        return m_is_bool_switch;
    }
    void set_as_bool_switch()
    {
